...
public class MemberController {
	...
	public ModelAndView personJoin(PersonVo personVo, @RequestParam(value = "imgFile") MultipartFile imgFile) {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView companyJoin(CompanyVo companyVo, @RequestParam(value = "imgFile") MultipartFile imgFile) {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView personList(@ModelAttribute("sessionId") String sessionId,
	...
	public ModelAndView companyList(@RequestParam(value = "currentPage", defaultValue = "1") int currentPage,
			@RequestParam(value = "selectOption", required = false) String selectOption,
			@RequestParam(value = "selectValue", required = false) String selectValue) {
	...
	public ModelAndView adminPersonList(@ModelAttribute("sessionId") String sessionId,
			@RequestParam(value = "currentPage", defaultValue = "1") int currentPage,
			@RequestParam(value = "selectOption", required = false) String selectOption,
			@RequestParam(value = "selectValue", required = false) String selectValue) {
		Map<String, Object> map = memberService.personList(currentPage, selectOption, selectValue, sessionId);
	...
	public ModelAndView memberDrop(@RequestParam(value = "memberId") String memberId) {
	...
	public ModelAndView personModify(PersonVo personVo, @RequestParam(value = "memberId") String memberId) {
	...
	public ModelAndView personModify(PersonVo personVo, @RequestParam(value = "imgFile") MultipartFile imgFile) {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView companyModify(CompanyVo companyVo, @RequestParam(value = "imgFile") MultipartFile imgFile) {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView memberIdFind(@RequestParam(value = "memberNm") String memberNm,
	...
	public ModelAndView memberPwFind(@RequestParam(value = "memberNm") String memberNm,
			@RequestParam(value = "memberEmail") String memberEmail,
	...
	public ModelAndView friendAdd(@ModelAttribute("sessionId") String memberId,
	...
	public ModelAndView friendList(@ModelAttribute("sessionId") String memberId) {
	...
	public ModelAndView friendApprove(@RequestParam("memberId") String memberId,
			@ModelAttribute("sessionId") String sessionId, @RequestParam("approveStateCd") int approveStateCd) {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView friendTotalList(@ModelAttribute("sessionId") String sessionId) {
	...
	public ModelAndView friendCheckList(@ModelAttribute("sessionId") String sessionId) {
	...
	public ModelAndView friendDelete(@ModelAttribute("sessionId") String sessionId,
	...
	// 페이지친구체크
		...
		public ModelAndView pageFriendCheck(@ModelAttribute("sessionId") String sessionId,
	...
	// 페이지친구추가
	@RequestMapping(value = "pageFriendAdd", method = RequestMethod.GET)
	public ModelAndView pageFriendAdd(@ModelAttribute("sessionId") String memberId,
			@ModelAttribute(value = "pageId") String pageId) {
		ModelAndView mv = new ModelAndView();
		int result = memberService.friendAdd(memberId, pageId);
