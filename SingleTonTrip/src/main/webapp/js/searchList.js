...
function searchPersonListHtml(searchPersonList) {
	...
	$.each(searchPersonList,function(key, item) {
		...
		if(item.memberImg != null){
			...
			html+="<img src='./assets/img/base/Male.png' class='img-rounded' width='100' height='100'>";
		}else if(item.personGender =='F'){
			html+="<img src='./assets/img/base/Female.png' class='img-rounded' width='100' height='100'>";
		}
		html+="</td>";
...
function searchCompanyListHtml(searchCompanyList) {
	...
	$.each(searchCompanyList,function(key, item) {
		...
		if(item.memberImg != null){
			...
			html+="<img src='./assets/img/base/Company.jpg' class='img-rounded' width='100' height='100'>";
		}
		html+="</td>";
		html+="<td><a href='pageMain?pageId="+item.memberId+"'>"+item.memberId+"</a></td>";
